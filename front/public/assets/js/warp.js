  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      function i(e) {
        ...
        for (var r = 1; r < e.length; r++) {
          ...
          (t[i] = e[r][0]),
            (t[o] = e[r][1]),
            e[r].length > 2 && ((t.extended = t.extended || {}), (t.extended[n] = e[r].slice(2)));
        }
        return t;
      }
      function o(e, t) {
        if (e.type === t.type && e.relative === t.relative) {
          var r = function (e, t, r) {
              if (e && t) {
                for (var n = [], a = Math.min(e.length, t.length), i = 0; i < a; i++)
                  n.push((e[i] + t[i]) / 2);
                y.extended[r] = n;
              }
            },
          ...
          switch (n) {
            ...
            case 'c':
              (y.x1 = (e.x1 + e.x2) / 2),
                ...
                (y.x2 = (t.x1 + t.x2) / 2),
                (y.y2 = (t.y1 + t.y2) / 2),
                l && (r(e.extended[0], e.extended[1], 0), r(t.extended[0], t.extended[1], 1));
              break;
            default:
              return !1;
          }
        ...
        return e
          .map(function (e) {
            ...
            var y = !0,
              ...
              c = void 0;
            try {
              for (var v, p = u[Symbol.iterator](); !(y = (v = p.next()).done); y = !0) {
                var s = v.value,
                  d = e[s],
                  h = void 0;
    ...
    function (e, t, r) {
      ...
      function n(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          o = void 0;
        try {
          for (var l, u = Object.keys(t)[Symbol.iterator](); !(n = (l = u.next()).done); n = !0) {
            var y = l.value;
            i(r, y, t[y]);
          }
        } catch (e) {
      ...
      function a(e, t) {
        return e[t] instanceof SVGAnimatedLength ? e[t].baseVal.value : e.getAttribute(t);
      }
      function i(e, t, r) {
        e.setAttribute(t, r);
      }
      ...
      function n(e) {
        for (
          ...
          for (var i = a[a.length - 1], o = [], l = 1; l < i.length; l++) {
            for (
              var u = i[l - 1], y = i[l], f = [], c = Math.max(u.length, y.length), v = 0;
              v < c;
              v++
            ) {
              var p = u[v] || 0,
        ...
        for (var d = 0; d < a.length; d++) r.push(a[d][0]), n.push(a[a.length - 1 - d][d]);
        return [r, n];
      }
      function a(e, t) {
        for (
          ...
          var l = a.pop();
          if (r(l) > t) for (var u = n(l), y = u.length - 1; y >= 0; y--) a.push(u[y]);
          else o.push(l);
        }
        return o;
      }
      function i(e) {
        for (var t = e[0], r = e[e.length - 1], n = 0, a = 0; a < t.length; a++) {
          var i = r[a] - t[a];
          n += Math.pow(i, 2);
        }
        return Math.sqrt(n);
    ...
    function (e, t, r) {
      ...
      var o = (function () {
        ...
        b = (function () {
          function e(t) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 'q';
            i(this, e), (this.element = t), (0, l.shapesToPaths)(t), (0, l.preparePaths)(t, r);
    ...
    function (e, t, r) {
              ...
              try {
                for (
                  ...
                  var b = g.value,
                    N = b.nodeName,
                    w = b.nodeValue;
                  /^(x|y|x1|y1|x2|y2|width|height|r|rx|ry|cx|cy|points|d)$/.test(N) || (s[N] = w);
                }
              } catch (e) {
                (h = !0), (x = e);
              } finally {
      ...
      function o(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 'q',
          ...
          i = void 0;
        try {
          for (var o, l = r[Symbol.iterator](); !(n = (o = l.next()).done); n = !0) {
            var y = o.value,
      ...
      function n() {
        ...
        return function (l) {
          if (
            ...
            'z' !== l.type || isNaN(i) || ((r = i), (n = o), (i = NaN), (o = NaN)),
            l.relative)
          ) {
            var u = !0,
              y = !1,
              f = void 0;
            try {
              for (var c, v = e[Symbol.iterator](); !(u = (c = v.next()).done); u = !0) {
                var p = c.value;
                p in l && (l[p] += r);
              }
            } catch (e) {
            ...
            var s = !0,
              ...
              h = void 0;
            try {
              for (var x, g = t[Symbol.iterator](); !(s = (x = g.next()).done); s = !0) {
                var m = x.value;
                m in l && (l[m] += n);
              }
            } catch (e) {
      ...
      function n() {
        ...
        return function (u) {
          ...
          return (
            ...
            'c' === u.type
              ? ((a = (u.relative ? e : 0) + u.x2), (i = (u.relative ? t : 0) + u.y2))
              : ((a = NaN), (i = NaN)),
            't' === u.type &&
              ((o = isNaN(o) ? e : o),
              (l = isNaN(l) ? t : l),
            ...
            'q' === u.type
              ? ((o = (u.relative ? e : 0) + u.x1), (l = (u.relative ? t : 0) + u.y1))
              : ((o = NaN), (l = NaN)),
            'z' === u.type && ((e = r), (t = n)),
        ...
        return function (a) {
          ...
          switch (a.type) {
            ...
            case 'v':
              ...
              break;
            case 'z':
              (a.type = 'l'), (a.x = r - (a.relative ? e : 0)), (a.y = n - (a.relative ? t : 0));
              break;
            case 'a':
              (0 !== a.rx && 0 !== a.ry) ||
                ((a.type = 'l'),
      ...
      function n() {
        ...
        return function (o) {
          if (
            ...
            'z' !== o.type || isNaN(n) || ((t = n), (r = i), (n = NaN), (i = NaN)),
            'l' === o.type)
          ) {
            ...
            switch (((o.type = e), e)) {
              ...
              case 'c':
                var y = (o.x - l) / 3,
                  f = (o.y - u) / 3;
                (o.x1 = l + y), (o.y1 = u + f), (o.x2 = l + 2 * y), (o.y2 = u + 2 * f);
                break;
              default:
    ...
    function (e, t, r) {
      ...
      function n() {
        ...
        return function (i) {
          ...
          if (
            ...
            'z' !== i.type || isNaN(r) || ((e = r), (t = n), (r = NaN), (n = NaN)),
            'a' === i.type)
          ) {
            var u = i.relative ? 0 : e,
              ...
              w = void 0;
            try {
              for (var P, M = x[Symbol.iterator](); !(b = (P = M.next()).done); b = !0) {
                var _ = P.value;
                (_.relative = i.relative),
                  i.relative &&
                    'c' === _.type &&
                    ((_.x -= g), (_.x1 -= g), (_.x2 -= g), (_.y -= m), (_.y1 -= m), (_.y2 -= m)),
                  (g = _.x),
                  (m = _.y);
              }
            } catch (e) {
      ...
      function a(e, t, r, n, a, o, l, u, y) {
        ...
        if (m < 0) {
          ...
          (r *= b), (n *= b);
        } else g = ((o && l) || (!o && !l) ? -1 : 1) * Math.sqrt(m / (s * x + d * h));
        var N = (g * r * p) / n,
          w = (-g * n * v) / r,
          P = c * N - f * w + (e + u) / 2,
          M = f * N + c * w + (t + y) / 2,
        ...
        for (
          ...
          var q = Math.cos(_),
            ...
            V = k * (c * r * R + f * n * z),
            J = k * (f * r * R - c * n * z);
          S.push({ type: 'c', x: T, y: C, x1: e + G, y1: t + L, x2: T + V, y2: C + J }),
            (_ = I),
            (e = T),
            (t = C);
        }
    ...
    function (e, t, r) {
      ...
      function a() {
        ...
        return t.map(function (e, t) {
          return { type: 0 === t ? 'm' : 'l', relative: !1, x: e.x || e[0], y: e.y || e[1] };
        });
      }
      function i() {
        ...
        return (0, l.default)(e, function (e) {
          for (var r = 0; r < u.pointGroups.length; r++) {
            ...
            if (o in e && l in e) {
              ...
              if (c.length < 2) throw new Error('Transformer must return at least 2 points');
              (e[o] = c[0]),
                (e[l] = c[1]),
                c.length > 2 && ((e.extended = e.extended || {}), (e.extended[r] = c.slice(2)));
            }
          }
          return e;
        });
