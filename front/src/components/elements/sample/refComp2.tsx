...
interface ForwardRefComponent<IntrinsicElementString, OwnProps = object>
    ...
    <As extends keyof JSX.IntrinsicElements>(props: MergeProps<As, OwnProps & { as?: As }>): React.ReactNode | null;
    <As extends React.ElementType<unknown>, _AsWithProps = As extends React.ElementType<infer P> ? React.ElementType<P> : never>
        (props: MergeProps<_AsWithProps, OwnProps & { as?: _AsWithProps }>): React.ReactNode | null;
}
