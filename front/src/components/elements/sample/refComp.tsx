...
> = <T extends OnlyAs = Default>(
  props: AsProps<T, Props, React.ComponentPropsWithRef<T>>
...
> = Merge<
  React.ForwardRefExoticComponent<
    Merge<React.ComponentPropsWithoutRef<Default>, Props & { as?: Default }>
  >,
...
const Box = polymorphicFowardRef<'div', { open?: boolean }, 'p' | 'span' | 'div'>(
